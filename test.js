...
var example = {
	...
	username: "hajovsky",
	emails: ["juraj.hajovsky@example.com", "hajovsky@example.com"],
	stats: {
		starred: 3,
		followers: 0,
		following: 0
...
describe("halson", function() {
	...
	describe("getLink()", function() {
		...
		it("use filterCallback", function() {
			...
			assert.deepEqual(
				res.getLink("avatar", function(item) {
					return true;
				}),
			...
			assert.deepEqual(
				res.getLink("related", function(item) {
					return item.name === "twitter";
				}),
	...
	describe("getEmbed()", function() {
		...
		it("use filterCallback", function() {
			...
			var expected = halson(example._embedded.starred[1]);
			assert.deepEqual(
				res.getEmbed("starred", function(item) {
	...
	describe("insertEmbed()", function() {
		...
		it("add third embed (as an array) before second", function() {
			...
			var embed1 = { title: "Untitled1" };
			var embed2 = { title: "Untitled2" };
			var embed3 = [{ title: "Untitled3a" }, { title: "Untitled3b" }];
			var expected = {
				_embedded: {
					item: [
						{
